...
use vec_ode::{ODEState, ODESolver, ODESolverBase,  AdaptiveODESolver, LinearCombination};
//use crate::base::quantum::{QRep};
use qrs_core::quantum::eig::QEiger;
use qrs_core::reps::matrix::*;
use qrs_core::quantum::eig::EigJob;
